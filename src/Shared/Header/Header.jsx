...
const Header = () => {
	...
	return (
		<>
			...
			<nav
				className={`md:flex md:w-[65%] mx-auto md:justify-between z-40 md:h-[70px] absolute md:fixed md:p-10 md:px-20 left-0 right-0 duration-700 md:items-center ${
					isOpen ? 'pt-10 pb-3 md:p-0 bg-white' : '-mt-80 md:mt-0'
				} `}>
				<div className='flex items-center gap-3'>
					<img className='w-[170px]  hidden md:block' src={logo} alt='' />
				</div>
