...
const About = () => {
   return (
      <div className="my-[80px] flex justify-center items-center md:w-[80%] mx-auto">
         <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="space-y-6 text-white my-auto">
               ...
               <p className="text-gray-400">
                  ...
                  mattis magna facilisi fermentum, euismod vitae. Porttitor sit
                  tincidunt dictum facilisi eget orci velit. Nulla laoreet nunc
                  gravida augue aenean sed elementum, in.
               </p>
